              ...
              {(snapshotFormat === "pdf" || snapshotFormat === "jpg") && (
                <div className="space-y-2">
                  ...
                  <div
                    ...
                    style={{ minWidth: "800px", backgroundColor: "#ffffff", padding: "24px", borderRadius: "8px", border: "1px solid #e5e7eb" }}
                  >
                          ...
                          <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid #e5e7eb" }}>
                            <thead>
                              <tr style={{ backgroundColor: "#f9fafb" }}>
                                <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>账户</th>
                                <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>账户类型</th>
                                <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>资产</th>
                                <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>资产类型</th>
                                <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "right" }}>金额</th>
                              </tr>
                            </thead>
                            <tbody>
                              {group.items.map((item, index) => {
                                ...
                                return (
                                  <tr key={item.id} style={{ backgroundColor: index % 2 === 0 ? "#ffffff" : "#f9fafb" }}>
                                    ...
                                    <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>{accountTypeConfig.label}</td>
                                    <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>
                    ...
                    <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid #e5e7eb" }}>
                      <thead>
                        <tr style={{ backgroundColor: "#f9fafb" }}>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>账户</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>账户类型</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>账户号码</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>资产</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>资产类型</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "right" }}>金额</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "right" }}>账户总计</th>
                        </tr>
                      </thead>
                      <tbody>
                        {accounts.map((account, accountIndex) => {
                          ...
                          if (assets.length === 0) {
                            return (
                              <tr key={account.id} style={{ backgroundColor: accountIndex % 2 === 0 ? "#ffffff" : "#f9fafb" }}>
                                <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>
                                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                                    {LogoComponent ? (
                                      <LogoComponent size={16} className={nameColor.color} />
                                ...
                                <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>{accountTypeConfig.label}</td>
                                <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>{account.accountNumber || "-"}</td>
                                ...
                                <td
                                  style={{
                                    ...
                                    textAlign: "right",
                                    fontWeight: "500",
                                    color: account.totalAmount >= 0 ? "#16a34a" : "#dc2626"
                                  }}
                                >
                          ...
                          return assets.map((asset, assetIndex) => {
                            ...
                            return (
                              <tr
                                ...
                                style={{ backgroundColor: accountIndex % 2 === 0 ? "#ffffff" : "#f9fafb" }}
                              >
                                {assetIndex === 0 && (
                                  <>
                                    <td
                                ...
                                <td style={{ border: "1px solid #e5e7eb", padding: "8px", paddingLeft: "24px" }}>{asset.name}</td>
                                <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>{assetTypeConfig.label}</td>
                                <td
                                  style={{
                                    border: "1px solid #e5e7eb",
                                    padding: "8px",
                                    textAlign: "right",
                                    fontWeight: "500",
                                    color: assetAmount >= 0 ? "#16a34a" : "#dc2626"
                                  }}
                                >
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <table style={{ width: "100%", borderCollapse: "collapse", border: "1px solid #e5e7eb" }}>
                      <thead>
                        <tr style={{ backgroundColor: "#f9fafb" }}>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>日期</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>类型</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>账户</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "right" }}>金额</th>
                          <th style={{ border: "1px solid #e5e7eb", padding: "8px", textAlign: "left" }}>说明</th>
                        </tr>
                      </thead>
                      <tbody>
                        {records.map((record, index) => {
                          ...
                          return (
                            <tr key={record.id} style={{ backgroundColor: index % 2 === 0 ? "#ffffff" : "#f9fafb" }}>
                              ...
                              <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>
                                <span
                                  style={{
                                    ...
                                    fontSize: "12px",
                                    fontWeight: "500",
                                    backgroundColor: record.type === "INCOME" ? "#dcfce7" : "#fee2e2",
                                    color: record.type === "INCOME" ? "#15803d" : "#b91c1c"
                                  }}
                                >
                                  {record.type === "INCOME" ? "收入" : "支出"}
                                </span>
                              ...
                              <td style={{ border: "1px solid #e5e7eb", padding: "8px" }}>{record.description || "-"}</td>
                            </tr>
                          )
                        })}
                      </tbody>
