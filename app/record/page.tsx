                        ...
                        <>
                            ...
                            <ResponsiveTable>
                              ...
                              <ResponsiveTableBody>
                                {sortedRecords.map((record) => {
                                  return (
                                    <ResponsiveTableRow key={record.id} className="bg-card/50 hover:bg-muted transition-colors">
                                      ...
                                      <ResponsiveTableCell mobileLabel="资产">
                                        {record.asset ? (
                                          <span className="text-sm text-muted-foreground">{record.asset.name}</span>
                                        ) : (
                                      ...
                                      <ResponsiveTableCell mobileLabel="金额" className={`text-right font-mono font-semibold ${record.amount >= 0 ? "text-success" : "text-destructive"}`}>
                          ...
                          <div className="md:hidden space-y-3">
                            {sortedRecords.length === 0 ? (
                              ...
                              sortedRecords.map((record) => (
                                <div key={record.id} className="rounded-[16px] bg-card border border-border p-4">
                                  <div className="flex justify-between items-start mb-2">
                                    ...
                                    <div className={"text-lg font-mono font-semibold " + (record.amount >= 0 ? "text-success" : "text-destructive")}>
                                      {formatAmount(record.amount)}
                                    </div>
                                  </div>
                                  {/* 账户名和操作按钮放在同一行 */}
